...
- The home page hero plays `video/launion-hero.webm`, which is included in the repo, so it's the same for everyone on clone. If the file is ever missing, the hero falls back to a colored background.
